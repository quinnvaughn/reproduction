...
export declare class BaseRawConnection {
    ...
    _parse(query: string, outputFormat: OutputFormat, expectedCardinality: Cardinality, state: Session, privilegedMode?: boolean, options?: QueryOptions): Promise<ParseResult>;
