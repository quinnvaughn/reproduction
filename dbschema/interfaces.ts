...
export namespace helpers {
  export interface CreatedAndUpdatedAt extends std.$Object {
    "created_at": Date;
    "updated_at": Date;
  }
}
...
export namespace users {
  ...
  export interface User extends helpers.CreatedAndUpdatedAt {
    "role": Role;
    "email": string;
    "name": string;
    "password": string;
...
export interface types {
  ...
  "helpers": {
    "CreatedAndUpdatedAt": helpers.CreatedAndUpdatedAt;
  };
  "schema": {
